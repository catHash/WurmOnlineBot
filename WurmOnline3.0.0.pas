...
begin
  ...
  begin
    ...
    MoveMouse(IconLocation.x+25,IconLocation.y+5);
    HoldMouse(IconLocation.x+25,IconLocation.y+5,1);
    MoveMouse(PileLocation.x+50,PileLocation.y+100);
...
begin
  ...
  begin
    MoveMouse(IconLocation.x+25,IconLocation.y+5);
    HoldMouse(IconLocation.x+25,IconLocation.y+5,1);
    MoveMouse(BinLocation.x+50,BinLocation.y+100);
...
begin
  ...
  begin
    MoveMouse(IconLocation.x+25,IconLocation.y+5);
    HoldMouse(IconLocation.x+25,IconLocation.y+5,1);
    MoveMouse(InventoryLocation.x+50,InventoryLocation.y-100);
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        MoveMouse(ClayPoint.x,ClayPoint.y);
        GetMousePos(MousePos.x,MousePos.y);
        ClickMouse(MousePos.x,MousePos.y,1);
        wait(100);
        ClickMouse(MousePos.x,MousePos.y,1);
...
begin
  ...
  begin
    ...
    begin
      MoveMouse(DirtPoint.x+25,DirtPoint.y+5);
      HoldMouse(DirtPoint.x+25,DirtPoint.y+5,1);
      MoveMouse(CartPoint.x+50,CartPoint.y+100);
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        MoveMouse(OrePoint.x+25,OrePoint.y+5);
        HoldMouse(OrePoint.x+25,OrePoint.y+5,1);
        MoveMouse(BinPoint.X,BinPoint.Y+100);
...
begin
  ...
  begin
    ...
    begin
      MoveMouse(ClayPoint.x+25,ClayPoint.y+5);
...
begin
  ...
  begin
    ...
    begin
      GetMousePos(MousePos.x,MousePos.y);
      MoveMouse(MousePos.x+100,MousePos.y);
      Mouse(X+25,Y+5,0,0,true);
      result := true;
    end
    else
